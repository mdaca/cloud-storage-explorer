...
//      Context.LANGUAGE,
//      Context.APPLET, "adminGroup", "userGroup", "driveAdminGroup"
//   };
//
//   /*
...
//			Logger.getLogger("com.spinsys.mdaca.storage.explorer.rest.SpnegoLoginModule");
//
//   @Override
...
//      trace = true;//logger.isTraceEnabled();
//
//      // Search Context Settings
...
//      {
//        logger.log(Level.WARNING, "Unable to obtain bindCredentials from Vault: ", e);
//      }
//
...
//         {
//        	 logger.log(Level.WARNING, "Failed to parse: " + temp + ", using searchTimeLimit=" + searchTimeLimit, e);
//         }
//      }
//
...
//      {
//         logger.info("Using GSSAPI to connect to LDAP");
//         LoginContext lc = new LoginContext(jaasSecurityDomain);
//         lc.login();
//         Subject serverSubject = lc.getSubject();
//
//         logger.log(Level.INFO, "Subject = " + serverSubject);
//         logger.log(Level.INFO, "Logged in '" + lc + "' LoginContext");
//
...
//      {
//     	 logger.log(Level.INFO, "Login failed", (LoginException) result);
...
//      if (trace) {
//         logger.info("Identity - " + getIdentity().getName());
//      }
...
//         logger.log(Level.INFO, "Obtained LdapContext");
//
...
//         {
//            logger.info("Rejecting empty password.");
//            return;
//         }
//      }
//
...
//         {
//            logger.log(Level.WARNING, "Authentication failed - " + ne.getMessage(), ne);
...
//      {
//         if (trace) {
//            logger.info("rolesCtxDN=" + rolesCtxDN + " roleFilter=" + roleFilter + " filterArgs[0]=" + filterArgs[0]
...
//            catch (NamingException e)
//            {
//               logger.log(Level.WARNING, "Problem closing results", e);
//            }
//         }
//      }
//
...
//   {
//      if (trace) {
//         logger.info("rolesSearch resultDN = " + dn);
//      }
//
//      String[] attrNames =
//      {roleAttributeID};
...
//      {
//         loadRoleByRoleNameAttributeID(searchContext, dn);
...
//      if (trace) {
//         logger.info("Using roleDN: " + roleDN);
//      }
//      try
//      {
...
//      catch (NamingException e)
//      {
//          logger.log(Level.INFO, "Failed to query roleNameAttrName", e);
//      }
//   }
//
...
//            if (trace) {
//               logger.info("Recursive search for '" + roleDN + "'");
//            }
...
//         {
//            if (trace) {
//               logger.info("Already visited role '" + roleDN + "' ending recursion.");
//            }
//         }
//      }
//   }
...
//         }
//         
//         logger.info("Logging into LDAP server, env=" + tmp.toString());
//      }
//   }
//
...
//            if (trace) {
//               logger.info("Assign user '" + getIdentity().getName() + "' to role " + roleName);
//            }
//            userRoles.addMember(p);
//         }
//         catch (Exception e)
//         {
//			logger.log(Level.WARNING, "Failed to create principal: " + roleName + " " + e.getMessage(), e);
//         }
//      }
//   }
//
